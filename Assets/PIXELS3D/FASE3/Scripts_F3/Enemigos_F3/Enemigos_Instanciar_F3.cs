...
public class Enemigos_Instanciar_F3 : MonoBehaviour
{
    ...
    IEnumerator crearEnemigos()
    {
        ...
        while (true)
        {
            ...
            {
                float enemigoPosX = Random.Range(-6.5f, 6.5f);
                float enemigoPosY = 24;
                Vector3 posicionAleatoria1 = new Vector3(enemigoPosX, enemigoPosY, -2);
                Instantiate(enemigo, posicionAleatoria1, enemigo.transform.localRotation);
